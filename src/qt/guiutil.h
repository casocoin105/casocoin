...
/** Utility functions used by the CasoCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render CasoCoin addresses in monospace font
...
// Parse "casocoin:" URI into recipient object, return true on successful parsing
