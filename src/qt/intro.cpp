...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("CasoCoin Core"),
     ...
     * override -datadir in the casocoin.conf file in the default data directory
     * (to be consistent with casocoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
