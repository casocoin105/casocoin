...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CasoCoin Core casocoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  casocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded casocoin transaction") + "\n" +
                               "  casocoin-tx [options] -create [commands]   " + _("Create hex-encoded casocoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded casocoin transaction
