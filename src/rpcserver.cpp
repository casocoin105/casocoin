...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop CasoCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "CasoCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CasoCoin features */
        {"casocoin", "masternode", &masternode, true, true, false},
        {"casocoin", "listmasternodes", &listmasternodes, true, true, false},
        {"casocoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"casocoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"casocoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"casocoin", "masternodedebug", &masternodedebug, true, true, false},
        {"casocoin", "startmasternode", &startmasternode, true, true, false},
        {"casocoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"casocoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"casocoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"casocoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"casocoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"casocoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"casocoin", "mnbudget", &mnbudget, true, true, false},
        {"casocoin", "preparebudget", &preparebudget, true, true, false},
        {"casocoin", "submitbudget", &submitbudget, true, true, false},
        {"casocoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"casocoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"casocoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"casocoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"casocoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"casocoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"casocoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"casocoin", "checkbudgets", &checkbudgets, true, true, false},
        {"casocoin", "mnsync", &mnsync, true, true, false},
        {"casocoin", "spork", &spork, true, true, false},
        {"casocoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"casocoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use casocoind, or the -server option to casocoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> casocoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1: 2398/\n";
}
