...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000a138f726c3392e457edb7b656ab076e92981e46955a57ff5a2482608467"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1531756086, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort =  2397;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // CasoCoin starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // CasoCoin: 1 day
        nTargetSpacing = 1 * 60;  // CasoCoin: 1 minute
        nLastPOWBlock = 1000;
        nMaturity = 20;
        nMasternodeCountDrift = 20;
        nMasternodeCollateralLimit = 3000;
        nModifierUpdateBlock = 615800;
        nMaxMoneyOut = 21000000 * COIN;

        const char* pszTimestamp = "The best throw of the dice is to throw them away - King Of Gambler";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1531756086;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 2577369;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000a138f726c3392e457edb7b656ab076e92981e46955a57ff5a2482608467"));
        assert(genesis.hashMerkleRoot == uint256("0xd50dd495d1697e65ee1f1e0a8bca93292f01a3b9dc8d62800919a2a865a9c484"));
        ...
        strObfuscationPoolDummyAddress = "coafsibtjwvqYE1T7Lce5uYbdt3pf6PKUu";
        nStartMasternodePayments = 1531756086;
    }
...
*/
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet casocoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet casocoin script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet casocoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet casocoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet casocoin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // CasoCoin: 1 day
        nTargetSpacing = 1 * 60;        // CasoCoin: 1 minutes
