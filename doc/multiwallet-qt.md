...
In order to support loading of multiple wallets in casocoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is casocoin.cpp.
...
Changes to casocoin.cpp
----------------------
casocoin.cpp is the entry point into casocoin-qt, and as such, will require some minor modifications to provide hooks for
